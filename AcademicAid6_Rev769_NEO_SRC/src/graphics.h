 ...
 * @param dy - top target position in destination image
 */
extern void blitAlphaImageToScreen(float sx, float sy,float width, float height, Image* source, float dx, float dy);
...
extern inline void blit(Image* img,float x, float y);

extern inline void blitresize(Image* img,float x,float y,float width,float height,int soften);

extern inline void blitcrop(Image* img,float x,float y,float width, float height);
...
extern void RenderImage(Image* pImg,float u0,float v0,float u1,float v1,float x_pos,float y_pos,float width,float height, int soften);
...
extern void drawLineScreen(int x0, int y0, int x1, int y1, Color color);
...
extern void swizzle_fast(u8* out, const u8* in, unsigned int width, unsigned int height);

extern void swizzle( Image* img );

extern void moveImageToVram( Image* img);

extern void drawQuad(int x, int y, int width, int height, unsigned int color);

extern int GuDrawLine(float x1, float y1, float x2, float y2, unsigned int color);
